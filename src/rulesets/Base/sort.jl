# function rrule(::Val{partialsort}, xs::AbstractVector, k::Union{Integer,OrdinalRange}; kwargs...)
...
# end
function rrule(::Val{sort}, xs::AbstractVector; kwargs...)
...
# @abstractvector_rule sort(xs::AbstractVector; kwargs...)  ys=xs[sortperm(xs; kwargs...)] 
