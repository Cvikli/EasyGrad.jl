...
function rrule(::Val{reshape}, A::AbstractArray, dims::Tuple{Vararg{Int}})
    A_dims = size(A)
...
function rrule(::Val{reshape}, A::AbstractArray, dims::Int...)
    A_dims = size(A)
    function reshape_pullback(Ȳ)
        ∂A = reshape(Ȳ, A_dims)
...
function rrule(::Val{hcat}, A::AbstractArray, Bs::AbstractArray...)
...
function rrule(::Val{reduce}, ::typeof(hcat), As::AbstractVector{<:AbstractVecOrMat})
...
function rrule(::Val{vcat}, A::AbstractArray, Bs::AbstractArray...)
...
function rrule(::Val{reduce}, ::typeof(vcat), As::AbstractVector{<:AbstractVecOrMat})
...
function rrule(::Val{fill}, value::Any, dims::Tuple{Vararg{Int}})
...
function rrule(::Val{fill}, value::Any, dims::Int...)
    function fill_pullback(Ȳ)
