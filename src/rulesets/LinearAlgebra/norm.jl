...
function rrule(::Val{norm}, x::Union{StridedArray, LinearAlgebra.AbstractTriangular, Diagonal},
    p::Real,
)
...
function rrule(::Val{norm}, x::Union{LinearAlgebra.TransposeAbsVec, LinearAlgebra.AdjointAbsVec},
    p::Real,
)
...
function rrule(::Val{norm}, x::Number, p::Real)
    y = norm(x, p)
    function norm_pullback(Δy)
...
function rrule(::Val{LinearAlgebra.normp} ,x::Union{StridedArray, LinearAlgebra.AbstractTriangular, Diagonal},
    p,
)
...
function rrule(::Val{LinearAlgebra.normMinusInf}, x::Union{StridedArray, LinearAlgebra.AbstractTriangular, Diagonal},
)
...
function rrule(::Val{LinearAlgebra.normInf}, x::Union{StridedArray,LinearAlgebra.AbstractTriangular,Diagonal},
)
...
function rrule(::Val{LinearAlgebra.norm1}, x::Union{StridedArray,LinearAlgebra.AbstractTriangular,Diagonal},
)
...
function rrule(::Val{LinearAlgebra.norm2}, x::Union{StridedArray,LinearAlgebra.AbstractTriangular,Diagonal},
)
...
function rrule(::Val{normalize}, x::AbstractVector, p::Real)
...
function rrule(::Val{normalize}, x::AbstractVector)
