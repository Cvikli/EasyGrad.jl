...
function rrule(::Val{eigen}, A::LinearAlgebra.RealHermSymComplexHerm{<:BLAS.BlasReal,<:StridedMatrix};
    kwargs...,
)
    F = eigen(A; kwargs...)
...
function rrule(::Val{eigvals}, A::LinearAlgebra.RealHermSymComplexHerm{<:BLAS.BlasReal,<:StridedMatrix};
    kwargs...,
)
...
function rrule(::Val{svd}, A::LinearAlgebra.RealHermSymComplexHerm{<:BLAS.BlasReal,<:StridedMatrix})
    F = svd(A)
...
function rrule(::Val{svdvals}, A::LinearAlgebra.RealHermSymComplexHerm{<:BLAS.BlasReal,<:StridedMatrix})
...
for func in (:exp, :log, :sqrt, :cos, :sin, :tan, :cosh, :sinh, :tanh, :acos, :asin, :atan, :acosh, :asinh, :atanh)
    @eval begin
        function rrule(::Val{$func}, A::LinearAlgebra.RealHermSymComplexHerm)
...
function rrule(::Val{sincos}, A::LinearAlgebra.RealHermSymComplexHerm)
